...
public class SuperController {
	...
	public ModelAndView CustomerPage() {
		return new ModelAndView("superclientDisplayPage");
	}
	...
	public ModelAndView billDisplayPage(@RequestParam("cnr") String cnr) {
		...
		bill.setRoomNumber(bookingDTO.getRoomNumber());
		bill.setCheckInDate(bookingDTO.getCheckInDate());
		bill.setCheckOutDate(bookingDTO.getCheckOutDate());
		bill.setRoomAmount(amount);
		bill.setExpenseAmount(bookingDTO.getAmountPayable());
		bill.setGst(100.0);
		bill.setTotalAmount(am+100.0);
		clientApi.billingsave(bill);
	...
	ModelAndView mv= new ModelAndView("accomodationEditPage");
	 ...
	 @GetMapping("/client-display")
		public ModelAndView ExpensesDisplayPage() {
	 ...
	 @GetMapping("/expenses-entry")
		...
		public ModelAndView ExpensesSave(@ModelAttribute("clientExpensesRecord") ExpensesDTO clientExpenses) {
			...
			clientApi.bookingsavewithexpences(bookingDTO);
			 ...
			 ModelAndView mv= new ModelAndView("redirect:/super/client-display");
		//	 List<ExpensesDTO> expensesList=clientApi.findAllExpenses();
		//	mv.addObject("expensesList",expensesList);
				return mv;
		}
